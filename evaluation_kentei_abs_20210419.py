...
def evaluation_kentei():
    ...
    for i in range(len(df)):
        ...
        if kentei[0] + kentei[1] - 2 == 10:
            if kentei[2] > 2.228 or kentei[2] < -2.228:
                kentei.append(1)
            else:
                kentei.append(0)

            if kentei[2] > 3.169 or kentei[2] < -3.169:
                kentei.append(1)
            else:
                kentei.append(0)

            if 1/7.1464 < kentei[3] < 7.1464:
                kentei.append(1)
            else:
                kentei.append(0)
            ...
            with open("evaluation_kentei/" + output_name[file_number], "a", newline="") as f:
                writer = csv.writer(f)
                writer.writerow([kentei[0] + kentei[1] - 2, kentei[2], 2.228, kentei[4], 3.169, kentei[5], kentei[3], kentei[6]])
